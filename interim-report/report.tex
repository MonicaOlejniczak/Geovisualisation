...
\begin{document}
	...
	\label{sec:project_plan}
		...
		\footnotetext[3]{\bibentry{tuomainen2014financial}}
		...
		\label{sec:evaluation}
			...
			The following criteria will be considered when evaluating and comparing the visualisations: time to render, time to perform operations after render, average frames per second, how they scale with small and large datasets and how different colours and schemes effect performance. 
