...
\label{sec:assertions}
	...
	\input{figures/testing/chai_assertions}
	...
	\label{sec:testing_asynchronous_support}
		...
		\input{figures/testing/mocha_asynchronous_code}
		...
		\input{figures/testing/chai_as_promised}
...
\label{sec:testing_structure}
	...
	\input{figures/testing/mocha_example}
...
\label{sec:testing_hooks}
	...
	\input{figures/testing/mocha_hooks}
...
\label{sec:testing_style}
	...
	\input{figures/testing/testing_style}
...
\label{sec:code_coverage}
	...
	\input{figures/testing/code_coverage}
