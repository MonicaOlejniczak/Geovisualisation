...
This chapter has highlighted how geovisualisations can be developed in WebGL through the implementation of three inheritance-based visualisations. These visualisations also demonstrate the potential of geovisualisations and how they can be applied to different datasets. Each visualisation utilises common navigation techniques, information displays for the data displays, filtering and configurable environment settings. Lastly, these features have been developed to provide the user with a range of tools for analysing the data presented to them.
