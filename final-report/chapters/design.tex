...
\label{sec:user_interface}
	...
	The user interface for this project makes use of Google's Material Design

% 	The User Interface of our system has been designed in a way that simplifies the way users interact with the system. The final design has been influenced by Google’s Material Design, using basic shapes and symbols to create a simple, easy-to-navigate interface.

% The User Interface team used a variety of technologies, from digital mockups to basic pen-and-paper drawings, to create a number of potential designs for the general system, with improvements made on each before the final design was chosen. This process fits with the agile approach, constantly tweaking designs before a final choice is made.
