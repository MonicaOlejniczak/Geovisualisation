...
\begin{abstract}
	...
	It was concluded that the system needs several improvements toward its usability and performance before it can be considered an effective tool for the analysis of geospatial data. Further work is recommended to make improvements in the system developed, which have been considered in the future work of this thesis.
